...
import com.example.todo.exception.NoRegisterArgumentException;
...
//        if (){}
    ...
    public LoginResponseDTO promoteToPremium(TokenUserInfo userInfo)
        throws NoRegisterArgumentException, IllegalStateException
    {
        ...
        User foundUser = userRepository
                ...
                .orElseThrow(
                        () -> new NoRegisterArgumentException("회원 조회에 실패!")
                );
